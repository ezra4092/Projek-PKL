                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                                ...
                                <div class="card shadow-lg my-5">
                                    <div class="card-body p-4 text-center"><div class="h2 fw-light mb-0">Lupa Password</div></div>
                                    <hr class="my-0" />
                                    <div class="card-body p-5">
                                        <div class="text-center mb-4">Silakan masukkan alamat email Anda, dan kami akan mengirimkan tautan untuk mereset kata sandi Anda.</div>
                                        ...
                                        <form action="{{route ('kirim-link')}}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-solid" type="email" name="email" id="email" placeholder="" required />
                                            </div>

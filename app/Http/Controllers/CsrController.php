...
class CsrController extends Controller
{
    ...
    public function hapus(Request $request) {
        ...
        return redirect()->route('csr')->with('success', 'Sertifikat dan dokumen berhasil dihapus.');
    }
    ...
    public function edit(Request $request) {
        ...
        return redirect()->route('csr')->with('success', 'Sertifikat berhasil diperbarui dengan dokumen baru.');
    }
